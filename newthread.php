            ...
            <form id="new_post_form" action="post_upload.php" method="post" enctype="multipart/form-data">
              ...
              <div class="new_post_bottom">
                <div class="new_post_image_container">
                  <label class="new_post_image_label"for="new_post_image">Add PNG image:</label>
                  <input class="new_post_image" accept=".png" id="new_post_image" name="new_post_image" type="file" form="new_post_form">
                </div>
