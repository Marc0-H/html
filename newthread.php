  ...
  <main>
    <div class="inner__main">
      ...
      <div class="main-content__container">
        <div class="newthread_main_content">
          <div class="new_thread_post">
            <div class="new_thread_content">
              <form id="new_thread_form" action="post_upload.php" method="post">
                <div class="new_thread-title-container">
                    <input name="post_title" id="new_thread_title" type="text" placeholder="Enter post title.." required>
                </div>
                <hr>
                <textarea name="post_content" id="new_thread_textarea" form="new_thread_form" maxlength="100" placeholder="Enter text..." required></textarea>
                <div class="new_thread_image_container">
                  <label for="new_thread_image">Add image:</label>
                  <input id="new_thread_image" type="file" form="new_thread_form">  <!--add name !-->
                </div>
                <hr>
                <div class="new_thread_bottom">
                  <div class="new_thread_tag">
                    <p class="tag_text">Tag:</p>
                    <div class="tag__container">
                      <select name="post_tag" id="tag_selector" form="new_thread_form">
                  ...
                  <input type="submit" class="new_thread_post_button" value="Post">
                </div>
              </form>
            </div>
          </div>
